...
resource "google_compute_network_peering" "live_dev_peering" {
  ...
  network      = try(data.google_compute_network.live_network.self_link, local.invalid_fallback_network_uri)
  peer_network = try(data.google_compute_network.dev_network.self_link, local.invalid_fallback_network_uri)
}
...
resource "google_compute_network_peering" "dev_live_peering" {
  ...
  network      = try(data.google_compute_network.dev_network.self_link, local.invalid_fallback_network_uri)
  peer_network = try(data.google_compute_network.live_network.self_link, local.invalid_fallback_network_uri)
}
...
resource "google_compute_network_peering" "live_stage_peering" {
  ...
  network      = try(data.google_compute_network.live_network.self_link, local.invalid_fallback_network_uri)
  peer_network = try(data.google_compute_network.stage_network.self_link, local.invalid_fallback_network_uri)
}
...
resource "google_compute_network_peering" "stage_live_peering" {
  ...
  network      = try(data.google_compute_network.stage_network.self_link, local.invalid_fallback_network_uri)
  peer_network = try(data.google_compute_network.live_network.self_link, local.invalid_fallback_network_uri)
}
